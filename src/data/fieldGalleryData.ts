...
export const FIELD_GALLERY_ITEMS: FieldGalleryItem[] = [
  ...
  },
  {
    ...
    legenda: 'Técnicas de saúde e supervisoras organizam as fichas físicas e digitais de acompanhamento no posto fixo temporário dentro da Galeria do Soba, assegurando fluxo contínuo de dados para o SisMob.',
...
export const FIELD_MOTIVATIONAL_QUOTES = [
  ...
  {
    quote: 'Com o ODK Collect e o SisMob apoiados pelo UNICEF, cada casa visitada e cada criança vacinada é registada em tempo real para cobertura de 100% no Sumbe.',
