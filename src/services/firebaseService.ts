...
const DEFAULT_PORTAL_POSTS: PortalPost[] = [
  ...
  },
  {
    ...
    conteudo: 'Técnicas de saúde e supervisoras organizam as fichas físicas e digitais de acompanhamento no posto fixo temporário dentro da Galeria do Soba, assegurando fluxo contínuo de dados para o SisMob.',
