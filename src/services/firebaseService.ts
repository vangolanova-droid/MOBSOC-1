...
const DEFAULT_PORTAL_POSTS: PortalPost[] = [
  {
    ...
    conteudo: 'As equipas de mobilizadores comunitários (RH-MC) iniciaram a rota intensiva de sensibilização casa a casa no município do Sumbe, informando as famílias sobre os postos fixos e avançados de vacinação no Cuanza Sul.',
  ...
  {
    id: 'post-2',
    titulo: 'Digitalização Completa dos Registos de Campo com ODK Collect Central',
    subtitulo: 'Mapeamento Georreferenciado',
    conteudo: 'Mais de 95% dos supervisores e mobilizadores do Sumbe já estão a sincronizar formulários digitais do ODK Collect em tempo real no SisMob, garantindo precisão geográfica e eliminação de falhas em papel.',
    categoria: 'Notícia',
    data: new Date().toISOString().split('T')[0],
    autor: 'Sistema Digital SisMob',
    destaque: true,
    imagemUrl: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1200&q=80',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'post-3',
    titulo: 'Estratégias de Diálogo para Resolução de Recusas Comunitárias',
    subtitulo: 'Comunicação Interpessoal & Hesitação',
    conteudo: 'Lançado o novo guia técnico de orientação interpessoal para mobilizadores lidarem com hesitação vacinal em feiras, igrejas e chafarizes comunitários com base em escuta ativa e dados científicos.',
    categoria: 'Guia',
    data: new Date().toISOString().split('T')[0],
    autor: 'Guia do Mobilizador',
    destaque: false,
    imagemUrl: 'https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?auto=format&fit=crop&w=1200&q=80',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'post-4',
    titulo: 'Vigilância Epidemiológica de Paralisia Flácida Aguda (PFA / Pólio)',
    subtitulo: 'Acompanhamento pela Saúde Municipal',
    conteudo: 'Alerta contínuo para notificação imediata de todos os casos suspeitos de PFA em crianças menores de 15 anos. Os registos integrados garantem resposta rápida com a equipa de epidemiologia.',
    categoria: 'Aviso',
    data: new Date().toISOString().split('T')[0],
    autor: 'Direção de Epidemiologia',
    destaque: true,
    imagemUrl: 'https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&w=1200&q=80',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'post-5',
    titulo: 'Balanço Geral de Cobertura e Cumprimento das Metas de Mobilização',
    subtitulo: 'Relatório Consolidado Cuanza Sul',
    conteudo: 'Atingidos 88% de cobertura nas rondas prioritárias de sensibilização social, registando mais de 12.000 cidadãos contactados diretamente nas áreas urbanas e periurbanas.',
    categoria: 'Estatística',
    data: new Date().toISOString().split('T')[0],
    autor: 'Coordenação Geral',
    destaque: false,
    imagemUrl: 'https://images.unsplash.com/photo-1526256262350-7da7584cf5eb?auto=format&fit=crop&w=1200&q=80',
    createdAt: new Date().toISOString(),
  },
];
