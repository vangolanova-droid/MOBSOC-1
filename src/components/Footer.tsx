...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-8 py-6 px-4 sm:px-6 transition-colors print:hidden">
      <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-600 dark:text-slate-400">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 text-center sm:text-left">
          ...
          <div className="flex items-center gap-1.5 font-bold text-blue-600 dark:text-blue-400">
            <span className="uppercase tracking-wider text-[10px] bg-blue-500/10 dark:bg-blue-400/10 px-2 py-0.5 rounded-full border border-blue-500/20 text-blue-700 dark:text-blue-300">
              INOVAÇÃO DIGITAL
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <ActionTooltip content="Enviar email diretamente para o suporte técnico da MELO TECH">
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-xl border border-slate-300/80 dark:border-slate-700 bg-white/60 dark:bg-slate-800/60 px-3 py-1.5 font-extrabold text-slate-700 dark:text-slate-200 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 dark:hover:text-white hover:border-blue-600 transition text-[11px] group cursor-pointer shadow-2xs"
            >
